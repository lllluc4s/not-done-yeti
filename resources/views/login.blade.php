...
@section('content')
    <!-- Conteúdo da página de login Livewire -->
    ...
    <form>
            ...
            <div class="inputGroup inputGroup1">
                <label for="loginEmail" id="loginEmailLabel">Digite o email pro Yetão</label>
